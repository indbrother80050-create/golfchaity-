  ...
  return (
    <div className="min-h-screen font-sans bg-[#f5f5f0]">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between h-16 items-center">
              <Link to="/" className="flex items-center space-x-2">
                ...
                <span className="text-xl font-serif font-bold tracking-tight text-[#2c2c28]">
                  GOLF CHARITY PRO
                </span>
              </Link>
              ...
              <div className="hidden md:flex items-center space-x-8">
                <Link
                  to="/charities"
                  className="text-sm font-medium text-[#4a4a44] hover:text-[#5A5A40] transition-colors"
                >
                  Charities
                </Link>
                {user ? (
                  ...
                  <>
                    ...
                    <Link
                      to="/register"
                      className="bg-[#5A5A40] text-[#f5f5f0] px-5 py-2.5 rounded-full text-sm font-medium hover:bg-[#4a4a34] transition-all"
                    >
                      Get Started
                    </Link>
                  </>
      ...
      <main>
        <React.Suspense
          fallback={
            <div className="flex items-center justify-center h-[calc(100vh-64px)] text-[#6b6b63]">
              Loading...
            </div>
          }
        >
        ...
        <footer className="bg-[#fdfdfc] border-t border-[#e8e8e3] py-12 mt-auto">
          <div className="max-w-7xl mx-auto px-4 text-center">
            <p className="text-sm text-[#6b6b63]">
              © 2026 Golf Charity Pro. All rights reserved.
            </p>
          </div>
        </footer>
      )}
