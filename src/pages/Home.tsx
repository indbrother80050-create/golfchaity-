    ...
    <div className="bg-[#f5f5f0] text-[#2c2c28] selection:bg-[#5A5A40]/20">
            ...
            <div className="lg:col-span-8">
              ...
              >
                <div className="flex items-center gap-2 mb-6">
                  ...
                  <span className="text-xs uppercase tracking-[0.3em] text-[#5A5A40] font-medium">EST. 2024 • THE PREMIER CLUB</span>
                </div>
                
                <h1 className="text-6xl md:text-8xl lg:text-[100px] font-light leading-[0.9] tracking-tighter mb-8 text-[#1a1a18]">
                  ELEVATE YOUR <br />
                  <span className="italic font-serif text-[#5A5A40]">LEGACY.</span>
                </h1>
            ...
            <div className="lg:col-span-4 hidden lg:block">
              ...
              >
                ...
                <div className="absolute bottom-12 left-8 right-8 text-center text-white">
                  ...
                  <div className="text-xs uppercase tracking-widest text-white/70">Featured Charity: Green Earth</div>
                </div>
              </motion.div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-12 text-center">
            {[
              ...
              <div key={i} className="space-y-2">
                <div className="text-4xl font-serif text-[#5A5A40]">{stat.value}</div>
                <div className="text-[10px] uppercase tracking-[0.2em] text-[#2c2c28]/60 font-bold">{stat.label}</div>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
            <div className="max-w-2xl">
              <h2 className="text-4xl md:text-5xl font-light tracking-tight mb-6 text-[#1a1a18]">
                DESIGNED FOR the <br />
                <span className="italic font-serif text-[#5A5A40]">MODERN GOLFER.</span>
              </h2>
            ...
            <div className="text-right">
              <div className="text-6xl font-serif italic text-[#5A5A40]/20">01—03</div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-5xl font-light tracking-tight mb-4 text-[#1a1a18]">
              FACES OF <span className="italic font-serif text-[#5A5A40]">IMPACT.</span>
            </h2>
            <p className="text-[#2c2c28]/70 font-light max-w-2xl mx-auto">
              Meet the generous donors and charity partners who make our mission possible. 
              Together, we are changing lives one swing at a time.
            </p>
          </div>
          
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              { name: "Sarah Jenkins", role: "Platinum Donor", img: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?q=80&w=800&auto=format&fit=crop" },
              { name: "Michael Chang", role: "Charity Partner", img: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=800&auto=format&fit=crop" },
              { name: "Elena Rodriguez", role: "Gold Donor", img: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?q=80&w=800&auto=format&fit=crop" },
              { name: "David Smith", role: "Foundation Lead", img: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?q=80&w=800&auto=format&fit=crop" },
            ].map((person, i) => (
              <div key={i} className="group relative aspect-[3/4] overflow-hidden rounded-full shadow-md">
                <img 
                  src={person.img} 
                  alt={person.name} 
                ...
                <div className="absolute bottom-8 left-0 right-0 text-center transform translate-y-4 group-hover:translate-y-0 transition-transform text-white">
                  ...
                  <div className="text-[10px] uppercase tracking-widest text-white/80 mt-1">{person.role}</div>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
            <div className="max-w-2xl">
              <h2 className="text-4xl md:text-5xl font-light tracking-tight mb-6 text-[#1a1a18]">
                THE TEAM BEHIND <br />
                <span className="italic font-serif text-[#5A5A40]">THE VISION.</span>
              </h2>
              <p className="text-[#2c2c28]/70 font-light">
                A dedicated group of golf enthusiasts, technologists, and philanthropists 
                working to bridge the gap between sport and social good.
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-12">
            {[
              { name: "James Wilson", role: "Founder & CEO", desc: "Former PGA pro turned tech entrepreneur.", img: "https://images.unsplash.com/photo-1560250097-0b93528c311a?q=80&w=800&auto=format&fit=crop" },
              { name: "Aisha Patel", role: "Head of Charities", desc: "15 years experience in global non-profit management.", img: "https://images.unsplash.com/photo-1580489944761-15a19d654956?q=80&w=800&auto=format&fit=crop" },
              { name: "Marcus Johnson", role: "CTO", desc: "Building secure, scalable systems for the modern web.", img: "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?q=80&w=800&auto=format&fit=crop" },
            ].map((member, i) => (
              <div key={i} className="space-y-6 group text-center">
                ...
                <div>
                  ...
                  <div className="text-xs uppercase tracking-widest text-[#5A5A40] mt-2 mb-3">{member.role}</div>
                  <p className="text-[#2c2c28]/60 font-light text-sm max-w-xs mx-auto">{member.desc}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <footer className="py-12 border-t border-[#2c2c28]/10 text-center text-[#2c2c28]/60 bg-white">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="text-xs uppercase tracking-[0.4em] font-bold text-[#5A5A40]">GOLF CHARITY PRO</div>
