    ...
    <div className="min-h-[calc(100vh-64px)] flex items-center justify-center px-4 py-12 bg-[#f5f5f0]">
      ...
      >
        <div className="text-center mb-10">
          <h2 className="text-4xl font-serif text-[#2c2c28] mb-2">Join the Club</h2>
          <p className="text-[#6b6b63]">Start tracking and contributing today</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            <label className="block text-sm font-medium text-[#4a4a44] mb-2 uppercase tracking-wider text-xs">Full Name</label>
            <input 
              type="text" 
              required
              value={formData.name}
          ...
          <div>
            <label className="block text-sm font-medium text-[#4a4a44] mb-2 uppercase tracking-wider text-xs">Email</label>
            <input 
              type="email" 
              required
          ...
          <div>
            <label className="block text-sm font-medium text-[#4a4a44] mb-2 uppercase tracking-wider text-xs">Select Charity</label>
            <select 
        ...
        <p className="text-center mt-8 text-sm text-[#6b6b63]">
          ...
          <Link to="/login" className="text-[#5A5A40] font-semibold hover:underline underline-offset-4">Sign in</Link>
        </p>
      </motion.div>
    </div>
  );
